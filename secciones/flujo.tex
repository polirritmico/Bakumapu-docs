...
\begin{enumerate}
	...
	\item \textbf{Columna Ajuste de tarjeta:} A cada tarjeta en esta columna habrá que asignarle una ID (revisar \nameref{flujo:nombres-de-tarjetas}, ajustar su nombre y descripción de modo que quede perfectamente claro de qué se trata. Si es necesario, añadir información relevante en la tarjeta.

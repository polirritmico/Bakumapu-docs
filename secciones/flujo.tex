...
Como ya se ha mencionado, la idea de este documento es triple: servir de instrumento de desarrollo, dar toda la información relevante sobre el funcionamiento técnico del desarrollo para integrar a nuevos miembros del equipo, y finalmente para servir de referencia ante dudas técnicas o de diseño.

Por su parte, el código en sí debe estar debidamente documentado por lo que para pequeñas modificaciones ---sobre todo en relación a funciones---, será suficiente con comentarlas dentro del código (revisar apartado \nameref{principios:documentacion-en-codigo}). No obstante, las modificaciones más importantes o que involucren cambiar o definir la interacción entre clases, deberán por lo menos estar mencionadas en este documento a modo de referencia técnica en el apartado \nameref{modelado:modelado-del-software}, para así mantener el sentido de este texto.

\subsubsection{Cómo usar este documento.}\label{flujo:como-usar-documento}
Lo ideal es una primera lectura para hacerse de una idea general del funcionamiento del software, o al menos tener una noción de lo que se pretende a nivel de diseño. Luego en esta primera etapa del desarrollo, la idea es usarlo a modo de referencia antes y durante la implementación de un área del código. Al finalizar ese trabajo, se debe actualizar el apartado correspondiente.

Para facilitar el acceso a la información relevante, se agrupan los contenidos en secciones afines, se añade un completo índice de contenidos y se agregan referencias cruzadas a otras secciones dentro del texto.
...
Dado que la instalación de \LaTeX\ puede ser engorrosa en ciertos contextos, no es necesario compilar una nueva versión con cada cambio, pero sí será conveniente para los cambios de versiones menores.
...
\paragraph{Ramas principales.}\label{pg:ramas-principales}
...
\paragraph{Alternativas al modelo de ramas de función.}\label{pg:alternativas-al-branching}
...
\subsubsection{Comandos de {\small GIT}.}\label{flujo:comandos-de-git}

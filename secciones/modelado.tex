...
\vspace{\baselineskip}
A nivel de arquitectura más global, tendremos la posibilidad de ajustar la interacción entre managers a través de GameManager, aislando los cambios internos de cada manager de su exterior. Es decir, cada manager operará como una caja negra, una estación en la cadena productiva cuyo funcionamiento interno es ignorado por el sistema, siendo lo único relevante sus inputs y outputs esperados.

De esta forma por ejemplo, podremos fusionar o separar el manager de datos entre uno que maneje los datos en la memoria dentro de Godot y uno que interactué con la base de datos; o por ejemplo, separar el manager de música con el de sonido sin cambiar el código de los managers específicos que lo utilizan concentrándonos exclusivamente en ajustar las llamadas en GM.

...
\begin{enumerate}
	...
	Añadir etiquetas para habilitar texto bidireccional, la identificación de idiomas (ISO-639) o hacer la \lsc{UI} compatible con el texto vertical y otras tipografías ajenas al alfabeto latino.
